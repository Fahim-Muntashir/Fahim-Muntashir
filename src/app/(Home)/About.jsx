...
const About = () => {
    return (
        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            <div>
                <h2 className="text-3xl font-bold tracki text-center sm:text-5xl dark:text-gray-50">About My Journey</h2>
                <p className="max-w-3xl mx-auto mt-4 text-xl text-center dark:text-gray-400">My Development Journey Share Now I am ,on here</p>
            </div>
